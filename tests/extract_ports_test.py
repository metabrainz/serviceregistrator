...
class TestExtractPortsExposedNotUsed(unittest.TestCase):
    def setUp(self):
        class DummyContainer:
            attrs = {
                "NetworkSettings": {
                    "Ports": {
                        "9200/tcp": [{"HostIp": "0.0.0.0", "HostPort": "65423"}, {"HostIp": "::", "HostPort": "65423"}],
    ...
    def test_extract_ports(self):
        ...
        self.assertEqual(set(ports), set([Ports(internal=9200, external=65423, protocol="tcp", ip="0.0.0.0")]))
