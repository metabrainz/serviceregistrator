...
class TestContainerInfo(unittest.TestCase):
    ...
    def test_services(self):
        ...
        id1 = self.container_info.SERVICE_ID_SEPARATOR.join(("my_host_name", "dummyservice", "8086"))
    ...
    def test_services_multiple(self):
        ...
        id1 = self.container_info.SERVICE_ID_SEPARATOR.join(("my_host_name", "dummyservice", "8086", "udp"))
        id2 = self.container_info.SERVICE_ID_SEPARATOR.join(("my_host_name", "dummyservice", "8087"))
